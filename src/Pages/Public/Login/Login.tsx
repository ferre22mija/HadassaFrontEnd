import { AbsoluteCenter, Box, Button, Center, Flex, FormControl, FormLabel, Input, Stack } from "@chakra-ui/react"
import "./style.css";
      ...
      <Box w="100vw" h="100vh" bg="#3a7ea4" p="2">
        <AbsoluteCenter>
          ...
          <Box boxShadow='lg' w="350px" h="70vh" borderRadius={10} overflow="hidden" position="relative"
            ...
            <Box w="500px" h="500px" borderRadius="40px" bg="white" transform="rotate(45deg)" position="absolute" left="-250px"></Box>
            <Box w="70%" h="100%" >
                  ...
                  <Center>
                    <ChakraLink as={Link} to="/admin/dashboard">
                      <Button size="lg" mt="8" ml="5" w="100%"
                        borderRadius="30px" boxShadow='md' bg="white" border="3px solid #5dc1b9"> INGRESAR</Button>
